...
insert into ad (id, typology, description, house_size, garden_size, score, irrelevant_since) values (1, 'CHALET', 'Este piso es una ganga, compra, compra, COMPRA!!!!!', 300, null, 90, null);
insert into ad (id, typology, description, house_size, garden_size, score, irrelevant_since) values (2, 'FLAT', 'Nuevo ático céntrico recién reformado. No deje pasar la oportunidad y adquiera este ático de lujo', 300, null, 90, null);
insert into ad (id, typology, description, house_size, garden_size, score, irrelevant_since) values (3, 'CHALET', '', 300, null, 40, null);
insert into ad (id, typology, description, house_size, garden_size, score, irrelevant_since) values (4, 'FLAT', 'Ático céntrico muy luminoso y recién reformado, parece nuevo', 300, null, 90, null);
insert into ad (id, typology, description, house_size, garden_size, score, irrelevant_since) values (5, 'FLAT', 'Pisazo,', 300, null, 90, null);
insert into ad (id, typology, description, house_size, garden_size, score, irrelevant_since) values (6, 'GARAGE', '', 300, null, 90, null);
insert into ad (id, typology, description, house_size, garden_size, score, irrelevant_since) values (7, 'GARAGE', 'Garaje en el centro de Albacete', 300, null, 90, null);
insert into ad (id, typology, description, house_size, garden_size, score, irrelevant_since) values (8, 'CHALET', 'Maravilloso chalet situado en lAs afueras de un pequeño pueblo rural. El entorno es espectacular, las vistas magníficas. ¡Cómprelo ahora!', 300, null, 90, null);
