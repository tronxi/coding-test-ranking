...
insert into ad (id, typology, description, house_size, garden_size, score, irrelevant_since) values (2, 'FLAT', 'Nuevo ático céntrico recién reformado. No deje pasar la oportunidad y adquiera este ático de lujo', 300, null, 40, null);
insert into ad (id, typology, description, house_size, garden_size, score, irrelevant_since) values (3, 'CHALET', '', 300, null, 20, null);
insert into ad (id, typology, description, house_size, garden_size, score, irrelevant_since) values (4, 'FLAT', 'Ático céntrico muy luminoso y recién reformado, parece nuevo', 300, null, 39, null);
insert into ad (id, typology, description, house_size, garden_size, score, irrelevant_since) values (5, 'FLAT', 'Pisazo,', 300, null, 10, null);
insert into ad (id, typology, description, house_size, garden_size, score, irrelevant_since) values (6, 'GARAGE', '', 300, null, 15, null);
...
insert into ad (id, typology, description, house_size, garden_size, score, irrelevant_since) values (8, 'CHALET', 'Maravilloso chalet situado en lAs afueras de un pequeño pueblo rural. El entorno es espectacular, las vistas magníficas. ¡Cómprelo ahora!', 300, null, 39, null);
